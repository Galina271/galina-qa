...
navHome: "Главная",
        ...
        navProjects: "Проекты",
        projEyebrow: "ПЕТ-ПРОЕКТ · iOS",
        projTitle: "Проекты",
        projSubtitle: "Я не только тестирую продукты — я их создаю. FoodStory — нативное iOS-приложение, которое я спроектировала, написала и протестировала от начала до конца.",
        projPlatform: "Приложение iOS&nbsp;26 · SwiftUI + SwiftData",
        projDesc: "Приложение-помощник для готовки: управление рецептами, пошаговый режим готовки с таймерами, подбор рецептов «что в холодильнике», AI-помощник и экспорт книги рецептов в PDF.",
        projF1: "Рецепты с сортировкой, поиском и избранным",
        projF2: "Пошаговый режим готовки с таймерами",
        projF3: "AI-помощник и предсказание категории на Core ML",
        projF4: "Локальное хранение на SwiftData + экспорт в PDF",
        projQa: "Взгляд QA: покрыто 8 наборами юнит-тестов и UI-тестами (XCTest / XCUITest) — свой код я тоже тестирую.",
        projGithub: "Открыть на GitHub",
        psTitle: "Мои рецепты",
        psSearch: "Поиск…",
        psR1: "Паста Карбонара",
        psR2: "Банановые панкейки",
        psR3: "Тыквенный суп",
        psEasy: "Легко",
        psMed: "Средне",
    },
    ...
    en:{
        ...
        projEyebrow: "PET PROJECT · iOS",
        projTitle: "Projects",
        projSubtitle: "I don't just test software — I build it too. FoodStory is a native iOS app I designed, coded and tested end to end.",
        projPlatform: "iOS&nbsp;26 app · SwiftUI + SwiftData",
        projDesc: "A cooking companion app: recipe management, a step-by-step cooking mode with timers, a \"what's in my fridge\" recipe matcher, an AI recipe assistant and PDF export of your recipe book.",
        projF1: "Recipes with sorting, search & favorites",
        projF2: "Step-by-step cooking mode with timers",
        projF3: "AI assistant & Core ML category prediction",
        projF4: "Local storage on SwiftData + PDF export",
        projQa: "QA angle: covered with 8 unit-test suites and UI tests (XCTest / XCUITest) — I test my own code too.",
        projGithub: "View on GitHub",
        psTitle: "My recipes",
        psSearch: "Search…",
        psR1: "Pasta Carbonara",
        psR2: "Banana Pancakes",
        psR3: "Pumpkin Soup",
        psEasy: "Easy",
        psMed: "Medium",
    }
